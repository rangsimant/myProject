...
<head>
	...
	<title>Bot samsung image</title>
</head>
<body>
		<div class="container">
				<div class="page-header" id="banner">
			        <div class="row">
			          <h4 id="navbar" class="col-md-2 alignright">#HASHTAG</h4>
			          <div class="col-md-6">
		                    <input type="text" class="form-control" placeholder="Search" id="tbSearch">
		                  </div>
  		                  	<h4 id="navbar" class="col-md-1 alignright">LIMIT</h4>
		                  <div class="col-md-1">
		                    <input type="text" class="form-control" placeholder="limit" id="tblimit">
		                  </div>
		                  <a id="btnSearch" name="but_submit" data-Style="zoom-out" type="button" value="Click"  class="lead btn btn-info ladda-button col-md-1" data-size="l"><span class="ladda-label">SEARCH</span></a>
 					</div>
			      </div>
			     	<div id="table"></div>
				</div>
