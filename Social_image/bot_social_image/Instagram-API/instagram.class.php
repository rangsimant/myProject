...
class Instagram {
   ...
   * @param integer [optional] $id        Instagram user ID
   * @param integer [optional] $limit     Limit of returned results
   * @param UNIX TIME [optional] $min_timestamp     Start of date
   * @param UNIX TIME [optional] $max_timestamp     End of date
   * @return mixed
   */
  public function getUserMediaRange($id = 'self',$min_timestamp = '0000000000',$max_timestamp = '0000000000', $limit = 0) {
    return $this->_makeCall('users/' . $id . '/media/recent', ($id === 'self'), array('count' => $limit,'min_timestamp'=>$min_timestamp,'max_timestamp'=>$max_timestamp));
  }
