...
$fb_username = array(
			...
			"samsungmobilejapan",
			"samsungmalaysia",
			"samsungmobilemalaysia",
			"SamsungNZ",
			"SamsungPH",
			"SamsungMobilePH",
			"SamsungSingapore",
			"SamsungMobileSingapore",
			"SamsungTaiwan",
			"SamsungMobileTaiwan",
			"samsungmobilethailand",
			"SamsungVietnam",
			"SamsungMobileVietnam",
			"samsungarmenia",
			"SamsungAustria",
			"SamsungBelgium",
			...
			"SamsungChile",
			"SamsungColombia",
			"SamsungMobileColombia",
			"samsungpanama",
			"SamsungPeru",
			"samsungmobileperu",
			"samsungvenezuela",
			"samsungmobilevenezuela",
			"SamsungPakistan",
			"SamsungGulf",
			"SamsungMobileArabia",
			"SamsungCanada",
...
function getIDFacebook($fb_username){
	...
	$db = new Db();
	 foreach ($fb_username as $key => $fb_username) {
		...
		$db->query("INSERT IGNORE INTO account(account_id_user,account_username,account_channel,account_subject) VALUES (:id_user,:username,'facebook','samsung')",
			array(
